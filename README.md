...
+ [13] Q. Qiu, W. Wang, H. Ying, **H. Gao***, and X. He. Stacked Asymmetric Convolution and Selective Feature Fusion for Large-scale Point Cloud-based Place Recognition. ***IEEE Robotics and Automation Letters***, Under Review.
+ [14] H Liu, **H. Gao***, J. Shi, C. Xu, D. Qu, and W. Hua. APMC-LOM: Accurate 3D LiDAR Odometry and Mapping based on Pyramid Warm-Up Registration and Multi-Constraint Optimization. ***IEEETransactions on Vehicular Technology***, Major Revisions.
